...
public class ClienteDAO {
    ...
    private static final String sqlinserir = "INSERT INTO clientes (id, nome, fone, email, idade) VALUES (?, ?, ?, ?, ?)";
    private static final String sqlalterar = "UPDATE clientes SET nome = ?, fone = ?, email = ?, idade = ? WHERE id = ?";
    ...
    public boolean Inserir(Cliente cli) {
        try {
            ...
            pstdados.setString(3, cli.getFone());
            pstdados.setString(4, cli.getEmail());
            pstdados.setInt(5, cli.getIdade());
    ...
    public boolean Alterar(Cliente cli) {
       try {
            ...
            pstdados.setString(2, cli.getFone());
